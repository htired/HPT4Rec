...
class SeqTrainer(Trainer):
    ...
    def save_user_emb(self):
        ...
        desc = 'Extracting Train User Embedding'

        train_loader = self.train_loader  # ✅ 改为训练集
        ...
        pickle.dump(user_emb, open(f"./dataset/{self.args.dataset}/usr_emb_{self.args.model_name}.pkl", "wb"))
    ...
    def save_item_emb(self):
        ...
        pickle.dump(item_emb, open("./dataset/{}/itm_emb_{}.pkl".format(self.args.dataset, self.args.model_name), "wb"))
